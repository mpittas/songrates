...
export default function PlaylistsHero({
  categoryCount,
  totalPlaylists,
  heroArtworks = [],
}: PlaylistsHeroProps) {
  const hasStats = categoryCount !== undefined && totalPlaylists !== undefined;
  ...
  return (
    <PageHero
      ...
      subtitle={
        <>
          <p>Dive deeper into the genres you love.</p>
          {hasStats ? (
            <div className="mt-3 flex flex-wrap gap-2">
              <StatChip>{categoryCount} genres</StatChip>
