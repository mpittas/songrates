...
export default function HomeHero() {
  return (
    <section className="relative border-b border-black/10">
      ...
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_0%_20%,rgba(255,127,95,0.35)_0%,rgba(143,29,40,0.2)_35%,transparent_65%)] pointer-events-none" />
      <div className="absolute inset-0 bg-[linear-gradient(120deg,rgba(255,255,255,0.18)_0%,rgba(255,255,255,0)_30%)] pointer-events-none" />
